...
import javafx.geometry.Pos; // [NEW IMPORT]
...
public class GuiController implements Initializable {
    ...
    @FXML private VBox nextPiecePanel; // [MODIFIED] Changed from GridPane to VBox
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // (nextPiecePanel setup removed here as it is now a VBox managed in renderNextPiece)
    ...
    private void renderNextPiece(List<int[][]> nextPieces) {
        ...
        // Loop through each next piece and create a separate centered grid for it
            ...
            for (int r = 0; r < nextData.length; r++) {
                for (int c = 0; c < nextData[r].length; c++) {
                    ...
                    if (nextData[r][c] != 0) {
                        ...
                        // Render transparent blocks to maintain perfect alignment/centering
                        rect.setFill(Color.TRANSPARENT);
                    }
                    pieceGrid.add(rect, c, r);
                }
            }
            // Add the perfectly centered grid to the VBox
